...
window.onload = function () {
  ...
  function insertText(lang_text) {
    ...
    selectorItem[0].getElementsByTagName('div')[0].querySelector('.banner__selector-text').innerHTML = langTextArr[6][1].replace(/{{price}}/g, price.year);
    selectorItem[0].getElementsByTagName('div')[1].querySelector('.banner__selector-text').innerHTML = langTextArr[8][1].replace(/{{price}}/g, price.week_yearly);
